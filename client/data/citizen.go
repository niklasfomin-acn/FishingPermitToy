...
func CreateCitizenFromForm(form *tview.Form) *Citizen {
	return &Citizen{
...
//func (p *Permit) CreatePermit(permitDate int, permitLocation string, permitType string)

func CreatePermitFromForm(form *tview.Form) *Permit {
	...
	return &Permit{
		...
		//PermitState:    form.GetFormItemByLabel("Permit State").(*tview.InputField).GetText(),
	}
}
